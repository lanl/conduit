...
class DepreciatedAction(int, metaclass=_enum_type_wrapper.EnumTypeWrapper):
    __slots__ = ()
    COPY: _ClassVar[DepreciatedAction]
    MOVE: _ClassVar[DepreciatedAction]
    RECURSIVE_COPY: _ClassVar[DepreciatedAction]
    RECURSIVE_MOVE: _ClassVar[DepreciatedAction]
...
COPY: DepreciatedAction
MOVE: DepreciatedAction
RECURSIVE_COPY: DepreciatedAction
RECURSIVE_MOVE: DepreciatedAction
...
class TransferDetails(_message.Message):
    ...
    DEPRECIATEDACTION_FIELD_NUMBER: _ClassVar[int]
    ...
    transferID: str
    depreciatedAction: DepreciatedAction
...
class TransferRequest(_message.Message):
    ...
    action: str
    options: _containers.MessageMap[str, _any_pb2.Any]
    def __init__(self, user: _Optional[str] = ..., depreciatedAction: _Optional[_Union[DepreciatedAction, str]] = ..., source: _Optional[_Iterable[str]] = ..., destination: _Optional[str] = ..., comment: _Optional[str] = ..., pausedState: _Optional[_Union[TransferState, str]] = ..., action: _Optional[str] = ..., options: _Optional[_Mapping[str, _any_pb2.Any]] = ...) -> None: ...
